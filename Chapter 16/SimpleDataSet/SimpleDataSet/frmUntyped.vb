...
Public Class frmUntyped
    ...
    Private Sub bttnEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnEdit.Click
        ...
        Try
            ...
            DS.Tables("Products").Rows(RND.Next(1, 78)).Item("UnitPrice") = -10 + Math.Round(RND.NextDouble * 40, 2)
        Catch ex As Exception
            MsgBox("Failed to edit product name!" & vbCrLf & ex.Message)
        End Try
        Try
            DS.Tables("Products").Rows(RND.Next(1, 78)).Delete()
        Catch ex As Exception
            MsgBox("Failed to delete product!" & vbCrLf & ex.Message)
        End Try
        ...
        Catch ex As Exception
            MsgBox("Failed to edit category name!" & vbCrLf & ex.Message)
        End Try
        ShowDataSet()
    End Sub
    ...
    Private Sub bttnLoad_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnLoad.Click
        ...
        bttnRejectChanges.Enabled = True
        bttnSubmit.Enabled = True
        bttnShow.Enabled = True
        bttnRejectChanges.Enabled = True
