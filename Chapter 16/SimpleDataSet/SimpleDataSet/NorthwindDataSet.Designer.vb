...
Partial Public Class NorthwindDataSet
    ...
    Private Sub InitClass()
        ...
        fkc = New Global.System.Data.ForeignKeyConstraint("FK_Products_Categories", New Global.System.Data.DataColumn() {Me.tableCategories.CategoryIDColumn}, New Global.System.Data.DataColumn() {Me.tableProducts.CategoryIDColumn})
...
Namespace NorthwindDataSetTableAdapters
    ...
    Partial Public Class CategoriesTableAdapter
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = SimpleDataSet.My.MySettings.Default.NorthwindConnectionString
        End Sub
    ...
    Partial Public Class SuppliersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [Suppliers] ([CompanyName]) VALUES (@CompanyName);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierID"& _ 
                ", CompanyName FROM Suppliers WHERE (SupplierID = SCOPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [Suppliers] SET [CompanyName] = @CompanyName WHERE (([SupplierID] = @Origi"& _ 
                "nal_SupplierID) AND ([CompanyName] = @Original_CompanyName));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT SupplierID"& _ 
                ", CompanyName FROM Suppliers WHERE (SupplierID = @SupplierID)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        SupplierID, CompanyName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            Suppliers"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal CompanyName As String, ByVal Original_SupplierID As Integer, ByVal Original_CompanyName As String, ByVal SupplierID As Integer) As Integer
            If (CompanyName Is Nothing) Then
                Throw New Global.System.ArgumentNullException("CompanyName")
            Else
        ...
        Public Overloads Overridable Function Update(ByVal CompanyName As String, ByVal Original_SupplierID As Integer, ByVal Original_CompanyName As String) As Integer
            Return Me.Update(CompanyName, Original_SupplierID, Original_CompanyName, Original_SupplierID)
        End Function
    End Class
