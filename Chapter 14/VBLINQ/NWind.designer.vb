...
Partial Public Class NWindDataContext
  ...
  Partial Private Sub DeleteOrder(instance As [Order])
    End Sub
  Partial Private Sub InsertProduct1(instance As Product1)
    End Sub
  Partial Private Sub UpdateProduct1(instance As Product1)
    End Sub
  Partial Private Sub DeleteProduct1(instance As Product1)
    End Sub
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.VBLINQ.My.MySettings.Default.NorthwindConnectionString, mappingSource)
		OnCreated
	End Sub
	...
	Public ReadOnly Property Product1s() As System.Data.Linq.Table(Of Product1)
		Get
			Return Me.GetTable(Of Product1)
		End Get
	End Property
...
Partial Public Class Category
	...
	Private _Product1s As EntitySet(Of Product1)
	...
	Public Sub New()
		...
		Me._Product1s = New EntitySet(Of Product1)(AddressOf Me.attach_Product1s, AddressOf Me.detach_Product1s)
		OnCreated
	End Sub
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Category_Product1", Storage:="_Product1s", ThisKey:="CategoryID", OtherKey:="CategoryID")>  _
	Public Property Product1s() As EntitySet(Of Product1)
		Get
			Return Me._Product1s
		End Get
		Set
			Me._Product1s.Assign(value)
		End Set
	End Property
	...
	Private Sub attach_Product1s(ByVal entity As Product1)
		Me.SendPropertyChanging
		entity.Category = Me
	End Sub
	
	Private Sub detach_Product1s(ByVal entity As Product1)
		Me.SendPropertyChanging
		entity.Category = Nothing
	End Sub
End Class
...
Partial Public Class Order_Detail
	...
	Private _Product1 As EntityRef(Of Product1)
	...
	Public Sub New()
		...
		Me._Product1 = CType(Nothing, EntityRef(Of Product1))
		OnCreated
	End Sub
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Product1_Order_Detail", Storage:="_Product1", ThisKey:="ProductID", OtherKey:="ProductID", IsForeignKey:=true)>  _
	Public Property Product1() As Product1
		Get
			Return Me._Product1.Entity
		End Get
		Set
			Dim previousValue As Product1 = Me._Product1.Entity
			If ((Object.Equals(previousValue, value) = false)  _
...
Partial Public Class Product1
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Product1_Order_Detail", Storage:="_Order_Details", ThisKey:="ProductID", OtherKey:="ProductID")>  _
	Public Property Order_Details() As EntitySet(Of Order_Detail)
		Get
			Return Me._Order_Details
		End Get
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Category_Product1", Storage:="_Category", ThisKey:="CategoryID", OtherKey:="CategoryID", IsForeignKey:=true)>  _
	Public Property Category() As Category
		Get
			Return Me._Category.Entity
		End Get
		Set
			...
			If ((Object.Equals(previousValue, value) = false)  _
				...
				If ((previousValue Is Nothing)  _
							= false) Then
					Me._Category.Entity = Nothing
					previousValue.Product1s.Remove(Me)
				End If
				Me._Category.Entity = value
				If ((value Is Nothing)  _
							= false) Then
					value.Product1s.Add(Me)
					Me._CategoryID = value.CategoryID
				Else
					Me._CategoryID = CType(Nothing, Nullable(Of Integer))
				End If
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Supplier_Product1", Storage:="_Supplier", ThisKey:="SupplierID", OtherKey:="SupplierID", IsForeignKey:=true)>  _
	Public Property Supplier() As Supplier
		Get
			Return Me._Supplier.Entity
		End Get
...
Partial Public Class Supplier
	...
	<Global.System.Data.Linq.Mapping.AssociationAttribute(Name:="Supplier_Product1", Storage:="_Product1s", ThisKey:="SupplierID", OtherKey:="SupplierID")>  _
	Public Property Product1s() As EntitySet(Of Product1)
		Get
			Return Me._Product1s
		End Get
